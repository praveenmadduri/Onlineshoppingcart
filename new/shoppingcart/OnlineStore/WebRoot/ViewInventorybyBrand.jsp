...
<tr>
  ...
  <br /> 
  <form id="form1" method="post" action="ViewInventorybyBrand.jsp?header=<%=request.getParameter("header")%>" name="inventory">
      ...
      <%
      	String flag = "false";
      				if (header.equals("list")) {
      					flag = "true";
      %>
        <td bgcolor="#C3D7BA"><input name="ch<%=i%>" type="checkbox" id="checkbox2" value="<%=request.getParameter("brandid")%>,<%=categoryid%>,<%=itemid%>"/></td> <%
 	}
 %> 
