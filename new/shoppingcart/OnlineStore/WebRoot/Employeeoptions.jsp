...
window.mm_menu_1224101012_0 = new Menu("root",150,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
   ...
   mm_menu_1224101012_0.addMenuItem("Category","location='employeeViewCategories.do?header=view'");
...
window.mm_menu_1224101649_0 = new Menu("root",150,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
   mm_menu_1224101649_0.addMenuItem("Items","location='viewEmployeeCustomerItems.do?header=view'");
...
window.mm_menu_1224101903_0 = new Menu("root",150,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
   mm_menu_1224101903_0.addMenuItem("View All Orders","location='viewEmployeeCustomerOrders.do'");
   // mm_menu_1224101903_0.addMenuItem("View Orders by Date","location='EmployeeViewOrdersByDate.jsp'");
...
window.mm_menu_1224122939_0 = new Menu("root",150,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
   mm_menu_1224122939_0.addMenuItem("Change&nbsp;Password","location='EmployeeChangePassword.jsp'");
   mm_menu_1224122939_0.addMenuItem("Change&nbsp;Question","location='EmployeeChangeQuestion.jsp?role=admin'"); 
...
<a href="EmployeeHome.jsp" >Home&nbsp;||&nbsp;</a></td><td>
...
<a href="#" name="link45" id="link45" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link45')" onMouseOut="MM_startTimeout();" >Items&nbsp;||&nbsp;</a></td><td>
