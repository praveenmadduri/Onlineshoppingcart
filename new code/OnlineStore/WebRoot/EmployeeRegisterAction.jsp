...
<html>
	...
	<body>
		<br>
		<%
			String target="EmployeeForm.jsp?regsstatus=Registration Failed"; 
				try{
		        ...
		        if(flag) 
		           target = "EmployeeForm.jsp?status=Registration Success"; 
		        else  
		            target = "EmployeeForm.jsp?status=Registration Failed"; 
		            }catch(Exception e){}
